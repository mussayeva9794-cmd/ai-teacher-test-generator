...
type LinkRow = { id: string; token: string; variant_name: string; is_active: boolean; settings: ShareSettings; created_at: string };
...
export default function TestPage() {
  ...
  async function createLink() {
    ...
    try {
      ...
      setMessage(`Ссылка создана: ${url}`); await refresh();
